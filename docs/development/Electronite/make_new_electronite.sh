...
#
# Example `./make_new_electronite.sh v39.2.3 electronite-v23.3.10`
#
# or with github token:
#   `./make_new_electronite.sh v39.2.3 electronite-v23.3.10 <token>`
...
git push --no-verify origin electronite-v39.2.3-beta
if [ "${CREDS}" == "" ]; then
