...
#
# Example `./make_new_electronite.sh v37.1.0 electronite-v23.3.10`
#
# or with github token:
#   `./make_new_electronite.sh v37.1.0 electronite-v23.3.10 <token>`
...
git push --no-verify origin electronite-v37.1.0-beta
if [ "${CREDS}" == "" ]; then
