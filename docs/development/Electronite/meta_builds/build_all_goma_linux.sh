...
# Meta Build script to get sources, and then build for x64 and arm64 by calling build_target_goma_linux.sh
...
#
# Example `./build_all_goma_linux.sh electronite-v25.3.2-beta results/linux/v25.3.2`
...
if [ -f $DEST_FILE ]; then
    ...
    ./build_target_goma_linux.sh $TARGET $DEST
fi
